...
class OpenFile {
  public:
    ...
    void WriteHeaderBack(int sectorNo);

    /**
     * Lab4:filesys extension
     * it's reasonable to set the updating time of a file from an OpenFile instance
     * thus we should export a getter for the file header
     */
    FileHeader* getFileHeader();
  private:
    FileHeader *hdr;			// Header for this file 
    int seekPosition;			// Current position within the file
    int fileHeaderSectorNo;
    int latestLength;
};
