...
/**
 * Lab7:vmem
 * swap space for user progs
 * this one formats every Nachos setup
 */
SynchDisk* swap;
/**
 * Lab7:vmem
 * virtual mem bit map to notificate the usage of sectors on the swap disk
 * also formats every Nachos setup
 */
BitMap* vmMap;
#endif
...
Initialize(int argc, char **argv)
{
    ...
    /**
     * Lab7:vmem
     * initialize the vmMap and swap space
     */
    swap = new SynchDisk("SWAP");
    vmMap = new BitMap(NumSectors);
#endif
